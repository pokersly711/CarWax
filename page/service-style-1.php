				...
				<div class="template-content">
					...
					<div class="template-section template-section-padding-1 template-clear-fix template-main">
						...
						<div class="template-component-header-subheader">
							<h2>Full External Wash and Shine</h2>
							<div></div>
						...
						<div class="template-align-center"> 
							<p>
								After working so hard to design and develop this website, it is time to get started. So, I am gonna run a Startup Special, any size vehicle, external wash and wax only, for $45.00. 
							</p>
						</div>
