<?php
		define('BOOKING_FORM_NAME','Carvenience');
		define('BOOKING_FORM_EMAIL','jhrenterprises2021@gmail.com');
		...
		define('BOOKING_FORM_SUBJECT','Carvenience On Demand Carwash: Booking');
