			...
			<div class="template-component-booking-item-content">
				...
				<ul class="template-component-booking-package-list">
					...
					<li data-id="basic-hand-wash-1" data-id-vehicle-rel="regular-size-car,compact-suv,minivan,pickup-truck,cargo-truck">
						...
						<!-- Header -->
						<h4 class="template-component-booking-package-name">Any size personal vehicle, exterior wash and wax only.</h4>
						...
						<div class="template-component-booking-package-duration">
							...
							<span class="template-component-booking-package-duration-value">45-75</span>
						...
						<ul class="template-component-booking-package-service-list">
							<li data-id="exterior-hand-wash">Save Money on a Package Deal!</li>
							<li data-id="towel-hand-dry">Limited time offer, 10,30, and 50 shine ups.</li>
					...
					<li data-id="basic-hand-wash-2" data-id-vehicle-rel="medium-size-car">
						...
						<!-- Header -->
						<h4 class="template-component-booking-package-name">Hand Wash and Wax (Limited Time Only)</h4>
						...
						<!-- Services -->
						<ul class="template-component-booking-package-service-list">
							<li data-id="exterior-hand-wash">Foam and Hand Washed</li>
							<li data-id="towel-hand-dry">Butter Shine Waxed</li>
							<li data-id="wheel-shine">External Trim and Glass cleaned and Protected</li>
						</ul>
					...
					<li data-id="deluxe-wash-1" data-id-vehicle-rel="regular-size-car,compact-suv,minivan,pickup-truck,cargo-truck">
						...
						<div class="template-component-booking-package-price">
							<span class="template-component-booking-package-price-currency">$</span>
							<span class="template-component-booking-package-price-total">110</span>
							<span class="template-component-booking-package-price-decimal">00</span>
						</div>
						<div class="template-component-booking-package-duration">
							<span class="template-icon-booking-meta-duration"></span>
							<span class="template-component-booking-package-duration-value">75-95</span>
							<span class="template-component-booking-package-duration-unit">min</span>
						</div>
						<ul class="template-component-booking-package-service-list">
							<li data-id="exterior-hand-wash">Exterior Hand Wash</li>
							<li data-id="towel-hand-dry">Interior Vacuum</li>
							<li data-id="wheel-shine">Blacked and Protected</li>
							<li data-id="tire-dressing">Tire & Rim Wash and Polished</li>
							<li data-id="windows-in-and-out">Windows In &amp; Out</li>
							<li data-id="sealer-hand-wax">Basic Totally clean Interior</li>
						</ul>
						<div class="template-component-button-box">
							<a href="#" class="template-component-button">Book Now</a>
						</div>
					...
					<li data-id="deluxe-wash-2" data-id-vehicle-rel="medium-size-car">
						<h4 class="template-component-booking-package-name">Commercial Fleet and Car Lot Packages</h4>
						<div class="template-component-booking-package-price">
							<span class="template-component-booking-package-price-currency">$</span>
							<span class="template-component-booking-package-price-total">Give</span>
							<span class="template-component-booking-package-price-decimal">Us</span>
						</div>
						<div class="template-component-booking-package-duration">
							<span class="template-icon-booking-meta-duration"></span>
							<span class="template-component-booking-package-duration-value">A</span>
							<span class="template-component-booking-package-duration-unit">Call</span>
						</div>
						<ul class="template-component-booking-package-service-list">
							<li data-id="exterior-hand-wash">Exterior Wash and Shine</li>
						...
						<div class="template-component-button-box">
							<a href="#" class="template-component-button">Contact Us</a>
						</div>
					</li>
