			...
			<div class="template-component-booking-item-content">
				...
				<ul class="template-component-booking-package-list">
					...
					<li data-id="basic-hand-wash-1" data-id-vehicle-rel="regular-size-car,compact-suv,minivan,pickup-truck,cargo-truck">
						...
						<!-- Header -->
						<h4 class="template-component-booking-package-name">Invest in your car and future. We offer 10, 30, 50 exterior shines for a discounted price below our regular price.</h4>
						
						<!-- Price -->
						<div class="template-component-booking-package-price">
							<span class="template-component-booking-package-price-currency">10</span>
							<span class="template-component-booking-package-price-total">exterior</span>
							<span class="template-component-booking-package-price-decimal">Shines</span>
						</div>
						
						<!-- Duration -->
						<div class="template-component-booking-package-duration">
							<span class="template-icon-booking-meta-duration">$</span>
							<span class="template-component-booking-package-duration-value">400</span>
							<span class="template-component-booking-package-duration-unit">00</span>
						</div>
						
						<!-- Services -->
						<ul class="template-component-booking-package-service-list">
							<li data-id="exterior-hand-wash">Exterior and Trim Wash</li>
							<li data-id="towel-hand-dry">Hand Polish</li>
							<li data-id="wheel-shine">and Wax.</li>
						</ul>
					...
					<li data-id="basic-hand-wash-2" data-id-vehicle-rel="medium-size-car">
						...
						<!-- Header -->
						<h4 class="template-component-booking-package-name">Our 30 shines services</h4>
						
						<!-- Price -->
						<div class="template-component-booking-package-price">
							<span class="template-component-booking-package-price-currency">$</span>
							<span class="template-component-booking-package-price-total"></span>
						...
						<div class="template-component-booking-package-duration">
							<span class="template-icon-booking-meta-duration"></span>
							<span class="template-component-booking-package-duration-value">60-90</span>
							<span class="template-component-booking-package-duration-unit">min</span>
						</div>
						
						<!-- Services -->
						<ul class="template-component-booking-package-service-list">
							<li data-id="exterior-hand-wash">Exterior Hand Wash and Wax</li>
